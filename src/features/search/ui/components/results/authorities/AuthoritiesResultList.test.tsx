...
describe('AuthoritiesResultList', () => {
  const mockData: SearchResultsTableRow[] = [
    {
      title: { label: 'Test Authority 1' },
      __meta: { id: '1', key: '1' },
    },
    {
      title: { label: 'Test Authority 2' },
      __meta: { id: '2', key: '2' },
    },
  ];
  ...
  const mockFormattedData = [
    {
      title: { label: 'Test Authority 1', children: <span>Test Authority 1</span> },
      __meta: { id: '1', key: '1' },
    },
  ];
  ...
  test('renders TableFlex with formatted data in search context', () => {
  ...
  test('passes correct context to useTableFormatter in search mode', () => {
    ...
    render(<AuthoritiesResultList context="search" />);
  ...
  test('passes correct context to useTableFormatter in complexLookup mode', () => {
    ...
    render(<AuthoritiesResultList context="complexLookup" onAssign={onAssign} />);
  ...
  test('passes onTitleClick callback to useTableFormatter', () => {
    mockUseFormattedResults.mockReturnValue(mockData);
    mockUseTableFormatter.mockReturnValue({
      formattedData: mockFormattedData,
      listHeader: mockListHeader,
    ...
    render(<AuthoritiesResultList onTitleClick={onTitleClick} />);
  ...
  test('passes checkFailedId callback to useTableFormatter', () => {
    ...
    render(<AuthoritiesResultList checkFailedId={checkFailedId} />);
