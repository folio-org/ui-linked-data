...
import { SEARCH_RESULTS_FORMATTER } from '@/features/search/utils/formatters';
import { SEARCH_QUERY_BUILDER } from '@/features/search/utils/queryBuilder';
...
import { Search, SearchControlPane } from '@/features/search';
