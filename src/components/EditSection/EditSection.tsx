  ...
  return resourceTemplates ? (
    <div className="edit-section">
      <div className="input-group">
        {resourceTemplates
          .find(i => i.id === 'lc:RT:bf2:Monograph:Work')
          ?.propertyTemplates.map((e: PropertyTemplate) => (
            <PropertyTemplate key={e.propertyLabel} entry={e} />
          ))}
        <hr />
        {resourceTemplates
          .find(i => i.id === 'lc:RT:bf2:Monograph:Instance')
          ?.propertyTemplates.map((e: PropertyTemplate) => (
            <PropertyTemplate key={e.propertyLabel} entry={e} />
          ))}
      </div>
