...
export const BASE_LOCALE = {
  ...
  'marva.delete': 'Delete',
  'marva.return': 'Return',
  'marva.rdSaveSuccess': 'Record created. Expect a short delay before resource is visible in FOLIO.',
  'marva.rdUpdateSuccess': 'Record updated. Expect a short delay before changes are visible in FOLIO.',
