...
describe('SchemaWithDuplicatesService', () => {
  ...
  test('duplicateEntry - adds a copied entry', () => {
    jest
      .spyOn(uuid, 'v4')
    ...
    const entry = { path: ['testKey-0', 'testKey-2', 'testKey-4'], uuid: 'testKey-4', children: ['testKey-5'] };
    const testResult = new Map([
      ...
      ['testKey-7', { path: ['testKey-0', 'testKey-2', 'testKey-7'], uuid: 'testKey-7', children: ['testKey-8'] }],
      [
        'testKey-8',
