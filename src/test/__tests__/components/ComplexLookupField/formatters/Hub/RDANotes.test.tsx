...
import { RDANotesFormatter } from '@components/ComplexLookupField/formatters/Hub/RDANotes';

jest.mock('@components/ComplexLookupField/formatters/Hub/BaseNotesFormatter', () => ({
